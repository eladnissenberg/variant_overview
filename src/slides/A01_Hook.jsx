    ...
    <div className="w-full h-full flex flex-col">
      <div className="flex-1 flex items-center px-6 md:px-20">
        <div className="flex-1">
          ...
          >
            <div
              className="inline-flex items-center px-3 py-1.5 md:px-4 md:py-2 rounded mb-6 md:mb-10"
              style={{
                background: 'rgba(15, 149, 104, 0.08)',
                border: '1px solid #0F9568',
              }}
            >
              <span className="text-[10px] md:text-xs font-medium uppercase tracking-[0.2em] text-cream">AI-Powered CRO</span>
            </div>
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-cream leading-[1.05] tracking-tighter"
          >
            What if
            <br />
            experimentation
            <br />
            just... <span className="text-emerald">worked?</span>
          </motion.h1>
          ...
          <motion.div
            ...
            className="mt-6 md:mt-10 h-[2px] w-16 md:w-24 origin-left bg-emerald"
          />
        </div>
        ...
        >
          <span
            className="text-[100px] lg:text-[140px] font-bold tracking-tighter text-cream/[0.04] leading-none select-none"
      ...
      <motion.div
        ...
        className="pb-4 md:pb-10 mx-6 overflow-hidden"
      >
        <div className="flex animate-scroll" style={{ width: 'max-content' }}>
          {[...logos, ...logos, ...logos].map((logo, i) => (
            <img
              ...
              style={{ filter: 'grayscale(100%) brightness(0) invert(1)', opacity: 0.45 }}
            />
          ))}
        </div>
      </motion.div>
