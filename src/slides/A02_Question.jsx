...
export default function A02_Question() {
  return (
    <div className="w-full h-full relative flex items-center justify-center px-5 md:px-20">
      ...
      <motion.h1
        ...
        className="text-2xl sm:text-3xl md:text-6xl lg:text-7xl font-light text-white leading-[1.15] tracking-tight text-center max-w-full md:max-w-5xl"
      >
