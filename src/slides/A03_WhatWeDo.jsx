...
export default function A03_WhatWeDo() {
  return (
    <div className="w-full h-full relative flex items-center justify-center px-5 md:px-24">
      ...
      <motion.div
        ...
        className="absolute top-10 left-5 md:top-16 md:left-20"
      >
      ...
      <motion.h1
        ...
        className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-light text-white/60 leading-[1.25] tracking-tight text-center max-w-full md:max-w-5xl"
      >
